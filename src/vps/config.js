...
export function createVpsConfig(env = process.env) {
  ...
  return {
    ...
    testFirmwareRequestTimeoutMs: bounded(env.TEST_FIRMWARE_REQUEST_TIMEOUT_MS, 12_000, 5_000, 60_000),
    testFirmwareDecryptTimeoutMs: bounded(env.TEST_FIRMWARE_DECRYPT_TIMEOUT_MS, 120_000, 10_000, 10 * 60_000),
    testFirmwareMaxCandidates: bounded(env.TEST_FIRMWARE_MAX_CANDIDATES, 10_000_000, 100_000, 50_000_000),
    testFirmwareScanLockMs: bounded(env.TEST_FIRMWARE_SCAN_LOCK_MS, 2 * 60 * 60_000, 60_000, 6 * 60 * 60_000),
    testFirmwareCacheRetentionDays: bounded(env.TEST_FIRMWARE_CACHE_RETENTION_DAYS, 90, 7, 365),
